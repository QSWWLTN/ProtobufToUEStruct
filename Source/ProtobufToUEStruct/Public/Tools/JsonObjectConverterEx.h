...
class  Q_FJsonObjectConverterEX
{
public:
...
public: // JSON -> UStruct
    ...
    static bool JsonObjectStringToUStruct(const FString& JsonString, OutStructType* OutStruct, int64 CheckFlags, int64 SkipFlags)
    {
        ...
        if (!Q_FJsonObjectConverterEX::JsonObjectToUStruct(JsonObject.ToSharedRef(), OutStruct, CheckFlags, SkipFlags))
        {
    ...
    */
    ...
    static bool JsonArrayToUStruct(const TArray<TSharedPtr<FJsonValue>>& JsonArray, TArray<OutStructType>* OutStructArray, int64 CheckFlags, int64 SkipFlags)
    {
        ...
        for (int32 i = 0; i < JsonArray.Num(); ++i)
        {
            ...
            if (!Q_FJsonObjectConverterEX::JsonObjectToUStruct(Value->AsObject().ToSharedRef(), OutStructType::StaticStruct(), &(*OutStructArray)[i], CheckFlags, SkipFlags))
            {
